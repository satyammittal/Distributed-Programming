...
mathprog_1(struct svc_req *rqstp, register SVCXPRT *transp)
{
	union {
		intpair add_1_arg;
		intpair sub_1_arg;
		String sendstrings_1_arg;
		request retrievefile_1_arg;
		chunksend sendfile_1_arg;
	} argument;
	char *result;
	...
	case SENDSTRINGS:
		...
		_xdr_result = (xdrproc_t) xdr_String;
		local = (char *(*)(char *, struct svc_req *)) sendstrings_1_svc;
		break;

	case retrievefile:
		_xdr_argument = (xdrproc_t) xdr_request;
		_xdr_result = (xdrproc_t) xdr_readfile_res;
		local = (char *(*)(char *, struct svc_req *)) retrievefile_1_svc;
		break;

	case sendfile:
		_xdr_argument = (xdrproc_t) xdr_chunksend;
		_xdr_result = (xdrproc_t) xdr_String;
		local = (char *(*)(char *, struct svc_req *)) sendfile_1_svc;
		break;
